...
appclose.post('/logout-user', async (req, res) => {
  const { userId } = req.body;

  // Ensure that the admin is authenticated before allowing logout
  // (You can implement admin authentication logic here)

  try {
    const { error } = await supabase.auth.signOutUser(userId);
